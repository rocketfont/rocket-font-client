...
const Card = () => {
    ...
    const onFormComplete = ({cardNumber, cardExpiry, bithday8, cardPassword2}: any) => {
            ...
            <div style={{width: '450px'}}>
                ...
                <Form labelAlign="left" onFinish={onFormComplete}>
                    ...
                    <Row style={{display: 'flex'}} gutter={10}>
                        <Col span="12">
                            <Form.Item name="cardExpiry" label="유효기간(월/년)" {...cardExtraLayout} >
                                <Input/>
                            </Form.Item>
                        </Col>
                        <Col span="12">
                            <Form.Item name="bithday8" label="생년월일(6자리)" {...cardExtraLayout}>
                                <Input type="password"/>
                            </Form.Item>
                        </Col>
                    </Row>
                    ...
                    <Button type="primary">신용카드 등록/업데이트 하기</Button>
                </Form>
            </div>
        </RocketFontLayout>)
}
